...
| `coulomb_coefficient` | `float` | `0.0` | `coulomb_coefficient` 的公开输入或数据字段。 |
| `viscous_coefficient` | `float` | `0.0` | `viscous_coefficient` 的公开输入或数据字段。 |
| `stiction_force` | `float` | `0.0` | `stiction_force` 的公开输入或数据字段。 |
| `zero_velocity_tolerance` | `float` | `1e-09` | `zero_velocity_tolerance` 的公开输入或数据字段。 |
