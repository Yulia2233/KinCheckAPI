...
| `max_effort` | `float` | 必填 | `max_effort` 的公开输入或数据字段。 |
| `max_speed` | `float | None` | `None` | `max_speed` 的公开输入或数据字段。 |
| `efficiency` | `float` | `1.0` | `efficiency` 的公开输入或数据字段。 |
