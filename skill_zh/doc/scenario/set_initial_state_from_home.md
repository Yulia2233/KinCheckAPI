...
```python
set_initial_state_from_home(*, scenario: Scenario) -> Scenario
```
...
```python
from kincheckapi.scenario import set_initial_state_from_home
```

## 用途

设置字段并返回更新后的不可变对象：`set_initial_state_from_home`。
