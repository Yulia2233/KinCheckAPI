...
Projected joint-axis datums lie in the XY plane at Z = 0; material layers are staggered in Z. With the crank along +X
...
# Physical axial stack; projected revolute datums remain at Z=0.
# Base boss top = 2 mm, lower link faces = 3..7 mm, upper = 8..12 mm.
LOWER_LINK_CENTER_Z = 5.0
COUPLER_CENTER_Z = 10.0
GROUND_PIN_BOTTOM_Z = -11.0
GROUND_PIN_HEAD_BASE_Z = 7.5
LINK_PIN_BOTTOM_Z = 3.2
LINK_PIN_HEAD_BASE_Z = 12.5
GUARD_SEAT_OFFSET_Z = 4.0  # raises post bottoms from -8 to the base top -4
