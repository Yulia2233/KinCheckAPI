...
BAR_THICKNESS = 4.0
# The ground solid is mounted on a separate axial layer. Connector origins stay
# at z=0 because the revolute axis is a line; this leaves the moving planar
# links free to sweep without intersecting the ground plate.
GROUND_GEOMETRY_Z_OFFSET = 5.0
COUPLER_GEOMETRY_Z_OFFSET = -5.0
...
GROUND_PIVOT_BOLT_SHANK_LENGTH = 7.0
...
# Historical initial-pose search hint. It is intentionally not emitted as a
# runtime angle limit: this Grashof crank-rocker is required to rotate through
# a full revolution.
CLOSURE_SEARCH_BOUNDS_DEG = (-30.0, 30.0)
