...
def _link_body(
    ...
    lightening_holes: bool,
    *,
    geometry_z_offset: float = 0.0,
) -> scad.Solid:
    ...
    def _eye(center: tuple[float, float]) -> scad.Solid:
        cylinder = scad.make_cylinder_rsolid(
            ...
            bottom_face_center=(
                center[0],
                center[1],
                geometry_z_offset - BAR_THICKNESS / 2.0,
            ),
        )
    ...
    web_bottom_z = geometry_z_offset - BAR_THICKNESS / 2.0
    ...
    top_flange = scad.make_box_rsolid(
        ...
        bottom_face_center=(
            center_distance / 2.0,
            0.0,
            web_bottom_z + BAR_THICKNESS - flange_thickness,
        ),
    )
    ...
    bore_a = scad.make_cylinder_rsolid(
        ...
        bottom_face_center=(
            0.0,
            0.0,
            geometry_z_offset - BAR_THICKNESS / 2.0 - 1.0,
        ),
    )
...
def make_link_part(
    ...
    *,
    ...
    body = _link_body(
        ...
        center_distance,
        lightening_holes,
        geometry_z_offset=geometry_z_offset,
    )
