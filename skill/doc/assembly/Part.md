...
Part(part_id: 'str', connectors: 'tuple[Connector, ...]' = (), asset_paths: 'Mapping[str, str]' = <factory>, asset_hashes: 'Mapping[str, str]' = <factory>, display_name: 'str | None' = None, source_path: 'str | None' = None, metadata: 'Mapping[str, Any]' = <factory>)
...
| `asset_paths` | `Mapping[str, str]` | default_factory | Public input or data field `asset_paths`. |
| `asset_hashes` | `Mapping[str, str]` | default_factory | Public input or data field `asset_hashes`. |
