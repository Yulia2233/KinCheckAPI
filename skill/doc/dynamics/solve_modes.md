...
| `request` | `kincheckapi.vibration.ModalRequest` | `ModalRequest(mode_count=6, fixed_dofs=(), frequency_min_hz=0.0, frequency_max_hz=None, participation_vector=(), participation_frame='model', participation_unit='dimensionless')` | Public input or data field `request`. |
