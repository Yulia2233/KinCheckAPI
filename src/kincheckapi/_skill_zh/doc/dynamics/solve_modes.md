...
| `request` | `kincheckapi.vibration.ModalRequest` | `ModalRequest(mode_count=6, fixed_dofs=(), frequency_min_hz=0.0, frequency_max_hz=None)` | `request` 的公开输入或数据字段。 |
