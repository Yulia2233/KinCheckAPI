...
| `joint_velocities` | `Mapping[str, float]` | 必填 | `joint_velocities` 的公开输入或数据字段。 |
| `joint_accelerations` | `Mapping[str, float]` | 必填 | `joint_accelerations` 的公开输入或数据字段。 |
| `actuator_efforts` | `Mapping[str, float]` | 必填 | `actuator_efforts` 的公开输入或数据字段。 |
