...
```python
write_scenario(*, scenario: Scenario, path: str | pathlib.Path) -> None
```
...
```python
from kincheckapi.scenario import write_scenario
```

## Purpose

Write a public object deterministically: `write_scenario`.
