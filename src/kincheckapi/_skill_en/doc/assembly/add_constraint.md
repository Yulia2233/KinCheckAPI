...
```python
add_constraint(*, assembly: AssemblyModel, constraint: Constraint) -> AssemblyModel
```
...
```python
from kincheckapi.assembly import add_constraint
```

## Purpose

Add data and return the updated immutable object: `add_constraint`.
