...
```python
motion_package(*, assembly: AssemblyModel, motion_result: MotionResult, output_path: str | pathlib.Path, asset_root: str | pathlib.Path | None = None, title: str | None = None, require_meshes: bool = False, metadata: Optional[Mapping[str, Any]] = None) -> MotionPackageArtifact
```
...
```python
from kincheckapi.export import motion_package
```

## Purpose

Public compatibility alias for `export_motion_package()`.
