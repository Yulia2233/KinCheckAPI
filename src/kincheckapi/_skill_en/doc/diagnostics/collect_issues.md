...
Collect and content-deduplicate `SimIssue` objects from multiple structured results.

## Parameters and Fields

| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `results` | `Iterable[Any]` | required | Public input or data field `results`. |

## Returns and Failures

Returns `tuple[SimIssue, ...]`.
