...
```python
format_result_for_agent(result: Any, operation: str | None = None) -> str
```
...
```python
from kincheckapi.diagnostics import format_result_for_agent
```

## Purpose

Format any public validation result and accept no style parameter.

## Parameters and Fields

| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `result` | `Any` | required | Public input or data field `result`. |
