...
```python
from kincheckapi.kinematics import PositionResult
```

## Purpose

PositionResult(*, passed: 'bool', joint_positions: 'Mapping[str, float]', component_poses: 'Mapping[str, Any]', residuals: 'tuple[Any, ...]' = (), issues: 'tuple[SimIssue, ...]' = ())
...
| `component_poses` | `Mapping[str, Any]` | required | Public input or data field `component_poses`. |
